Feature: US_122 Bir kullanıcı olarak "Bed & Breakfast" ilan oluşturma sayfasında, 10. stepte en az 5 en fazla 10 tane resim ekleyebilmeliyim.
  ...
  Scenario: TC001_US53 It should be able to add at least 5 images in step 10 on the "Bed & Breakfast"  ad creation page.
    Then user shouldn't save the pictures without adding minimum 5 pictures

  Scenario: TC002_US53 It should be able to add at most 10 images in step 10 on the "Bed & Breakfast" ad creation page.
